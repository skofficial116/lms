      ...
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
            ...
            <div className="pt-5">
              {courseData.courseContent.map((chapter, index) => (
                ...
                >
                  ...
                  >
                    <ul className="list-disc md:pl-10 pr-4 pl-4 py-2 text-gray-600 border-t border-gay-300">
          ...
          <div className="py-20 text-sm md:text-default">
            <h3 className="tex-xl font-semibold text-gray-800">
              Course Description
            </h3>
            <p
        ...
        <div className="course-card z-10 custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm=min-w-[420px]">
          ...
          <div className="p-5">
            ...
            <div className="flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500">
              ...
              <div className="h-4 w-px bg-gray-500/40"></div>
              <div className="flex items-center gap-1">
                <img src={assets.lesson_icon} alt="less icon" />
            ...
            <div className="pt-6">
              <p className="md:text-xl tet-lg font-medium text-gray-800">
